"""Plain text prompt bundle generator with Smart Context (File Extensions Breakdown & Dependencies)."""
import os
...
def generate_text_bundle(
    ...
    """
    Generates plain text document with Smart Context:
    1. REPORTED PROBLEM
