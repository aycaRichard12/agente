...
def generate_standalone_prompt(problem_desc: str = "") -> str:
    """
    Generates a professional copy-paste prompt instructing DeepSeek:
    1. How to analyze the attached project context files.
    2. What exact structured markdown response format to return.
    """
    problem_text = problem_desc.strip() if problem_desc.strip() else "[Describe aquí el problema que está ocurriendo]"
